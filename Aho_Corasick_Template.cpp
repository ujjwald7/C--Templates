...
//source : https://gist.github.com/phoemur/b23aff4fcc4474f10db121afedcd1e99
...
class Aho {
    ...
    struct Vertex {
        unordered_map<char, int> children {}; // Links to the child vertexes in the trie
